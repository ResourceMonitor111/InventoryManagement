...
public class FormatSelectorDialog extends DialogFragment {
    ...
    public static FormatSelectorDialog newInstance(FormatSelectorDialogListener listener, ArrayList<Integer> selectedIndices) {
        FormatSelectorDialog fragment = new FormatSelectorDialog();
