...
public class CameraSelectorDialog extends DialogFragment {
    ...
    public static CameraSelectorDialog newInstance(CameraSelectorDialogListener listener, int cameraId) {
        CameraSelectorDialog fragment = new CameraSelectorDialog();
