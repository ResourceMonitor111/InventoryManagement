...
public class AndroidscanappPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Androidscanapp";
	...
	private AndroidscanappPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new AndroidscanappPersistentManager();
		}
